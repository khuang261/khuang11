#Kelly Huang (with Erin Lee and Pak Ming Lau)
#SoftDev
#K05 - Teamwork, but Better this time; Printing a random member from a random team of KREWES
#2020-09-30
import random
...
rand_team = random.choice(list(KREWES.keys()))
team = KREWES[rand_team]
